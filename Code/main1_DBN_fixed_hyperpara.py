# -*- coding: utf-8 -*-
# DBN_Set fixed parameters randomly
...
plt.savefig('Loss Curve_6(a).jpg')
plt.show()
...
plt.figure()
plt.plot(test_label,c='indianred', label='true')
plt.plot(test_pred,c='royalblue',label='pred')
plt.legend()
plt.show()
